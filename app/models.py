...
class Condominio(BaseModel):
    ...
    qtd_habitacional = models.PositiveIntegerField(verbose_name='Quantas unidades há no condomínio?')
    ...
    tipo_pix = models.CharField(verbose_name='Tipo de chave pix', max_length=50, choices=CHAVE_PIX, null=True, blank=True)
    chave_pix = models.CharField(verbose_name='Chave pix',max_length=300, null=True, blank=True)
    observacao = models.TextField(verbose_name='Gostaria de deixar alguma observação adicional?', max_length=500, null=True, blank=True)
    ...
    contato_responsavel = models.CharField(verbose_name='Contato do responsável(telefone)', max_length=20, null=True)
